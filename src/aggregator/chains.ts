...
export const CROSS_CHAIN_TOKENS: TokenInfo[] = [
    ...
    // Arbitrum tokens (M15)
    { symbol: "ETH", name: "Ethereum", chainId: "arbitrum", address: "0x0000000000000000000000000000000000000000", decimals: 18, icon: "🔷" },
    { symbol: "USDC", name: "USD Coin", chainId: "arbitrum", address: "0xaf88d065e77c8cC2239327C5EDb3A432268e5831", decimals: 6, icon: "💵" },
    { symbol: "USDT", name: "Tether", chainId: "arbitrum", address: "0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9", decimals: 6, icon: "💵" },
    { symbol: "ARB", name: "Arbitrum", chainId: "arbitrum", address: "0x912CE59144191C1204E64559FE8253a0e49E6548", decimals: 18, icon: "🔵" },

    // Base tokens (M15)
    { symbol: "ETH", name: "Ethereum", chainId: "base", address: "0x0000000000000000000000000000000000000000", decimals: 18, icon: "🔷" },
    { symbol: "USDC", name: "USD Coin", chainId: "base", address: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", decimals: 6, icon: "💵" },
];
